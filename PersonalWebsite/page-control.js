...
function openPopup( pageName )
{
	...
	popupPage.addClass( 'popup' ).css( 'z-index' , '50' ).show();

	var closeImgLink = $( '<a id="closePopup" href="#"><img src="images/close.png" alt="close overlay" /></a>' );
	popupPage.append( closeImgLink );
	closeImgLink.click( function( e )
		{
			e.preventDefault();
			popupPage.removeClass( 'popup' ).hide();
			$( '#closePopup' ).remove();
		}
	);
}
...
{
	$( '#'+pageName ).removeClass( 'popup' ).hide();
